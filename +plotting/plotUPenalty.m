...
if nargin == 1
    myStates = varargin{1};
    plotInfo = struct('xLabel', 'Links', 'yLabel', 'Time', 'title', '\it{u}\rm Penalty');
elseif nargin == 2
    myStates = varargin{1};
    axesHandle = varargin{2};
    plotInfo = struct('xLabel', 'Links', 'yLabel', 'Time', 'title', '\it{u}\rm Penalty', 'axesHandle', axesHandle);
elseif (nargin == 3)
    myStates = varargin{1};
    axesHandle = varargin{2};
    myTitle = varargin{3};
    plotInfo = struct('xLabel', 'Links', 'yLabel', 'Time', 'title', strcat('\it{u}\rm Penalty', myTitle), 'axesHandle', axesHandle);
else
