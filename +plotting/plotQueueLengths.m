...
if nargin == 1
    myStates = varargin{1};
    plotInfo = struct('xLabel', 'Links', 'yLabel', 'Time', 'title', 'Queue Lengths');
elseif nargin == 2
    myStates = varargin{1};
    axesHandle = varargin{2};
    plotInfo = struct('xLabel', 'Links', 'yLabel', 'Time', 'title', 'Queue Lengths', 'axesHandle', axesHandle);
elseif (nargin == 3)
    myStates = varargin{1};
    axesHandle = varargin{2};
    myTitle = varargin{3};
    plotInfo = struct('xLabel', 'Links', 'yLabel', 'Time', 'title', strcat('Queue Lengths', myTitle), 'axesHandle', axesHandle);
else
